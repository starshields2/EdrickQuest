...
public class BasicInkExample1 : MonoBehaviour
{
  ...
  skillManager.SetHealOn();
    ...
    void RefreshView()
    {
        ...
        textLayoutGroup.padding.top = 154;
        ...
        choicesLayoutGroup.padding.left = 90;
        choicesLayoutGroup.padding.right = 0;
        choicesLayoutGroup.padding.top = 200;
        choicesLayoutGroup.padding.bottom = 130;
        choicesLayoutGroup.spacing = 15;
